...
int parser::Ast_Node_Code_Block::getDeclarationId(char* __n, bool& __glb) {
    ...
    if (environment_id == AST_NODE_CODE_BLOCK_ENVIRONMENT_GLOBAL) __glb = 1;
...
parser::Ast_Node_Function_Call::Ast_Node_Function_Call(int _declId, utils::LinkedList <Ast_Node_Expression*>* _params, bool _glb) :
