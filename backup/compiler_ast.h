...
namespace parser {
    ...
    struct Compiler_Control {
        ...
        ~Compiler_Control(); Compiler_Control(utils::LinkedList <Ast_Node_Name_Space*>*, utils::LinkedList <char*>*, bool, utils::LinkedList <Compiler_Code_Block*>*);
        ...
        Compiler_Code_Block* getCompilerCodeBlockFromNameSpaceBuiltIn(utils::LinkedList <char*>*);
