...
namespace parser {
    ...
    */
    ...
    struct Ast_Node_Code_Block : public Ast_Node {
        ...
        int environment_id, count_before;
        Names_Tracker* names_tracker;
        Name_Space* name_space;

        ~Ast_Node_Code_Block(); Ast_Node_Code_Block(Ast_Node_Code_Block*, Name_Space*, int);

        /* Generator */
        static Ast_Node_Code_Block* generate(Ast_Control*, Name_Space*, int, utils::LinkedList <char*>*);

        int getNamesCountBefore();

        bool confirmAstNodeId(int);
    ...
    struct Ast_Node_Variable : public Ast_Node {
        ...
        bool is_global; // Is variable name space global
    ...
    /* Represent a change in current namespace */
    struct Ast_Node_Name_Space_Change : public Ast_Node {

        Name_Space* name_space;
        Ast_Node* value;

        ~Ast_Node_Name_Space_Change(); Ast_Node_Name_Space_Change(Name_Space*, Ast_Node*);

        static utils::LinkedList <char*>* getNameSpaceScope(Ast_Control*, bool);

        static Ast_Node_Name_Space_Change* generate(Ast_Control*, bool);
