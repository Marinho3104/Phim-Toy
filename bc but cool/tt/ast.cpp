...
parser::Name_Space::~Name_Space() { delete names_used; delete declarations_id; delete name_space_scope; }

parser::Name_Space::Name_Space() {
    names_used = new utils::LinkedList <char*>();
    declarations_id = new utils::LinkedList <int>();
    name_space_scope = new utils::LinkedList <char*>();
}
...
bool parser::Name_Space::addNewName(char* __d, int __off) {
...
parser::Type_Information* parser::Type_Information::generate(parser::Ast_Control* __astCntrl) {
    ...
    case TOKEN_IDENTIFIER: 
        _usrDefDeclId = __astCntrl->current_block->getDeclarationId((*__astCntrl->tokens_collection)[__astCntrl->current_token_position]->phr);
